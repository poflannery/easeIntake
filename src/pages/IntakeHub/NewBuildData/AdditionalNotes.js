...
import { setAllOtherDetailsValue } from '../../../redux/NewBuildValuesReducer';
...
// local states
const [notes,setNotes] = useState(store.allOtherDetails)
...
const handleSaveInformation = () => {
  setSubmitting(true)
  dispatch(setAllOtherDetailsValue(notes))
  setTimeout(() => {
    console.log(store)
    setSubmitting(false)
    savedNotice()
...
const savedNotice = () => {
  ...
  return (
    <>
          ...
          defaultValue={store.allOtherDetails}
