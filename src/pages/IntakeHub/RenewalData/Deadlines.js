...
import { setBuildDeadlineRenewal, setEnrollmentDatesRenewal } from '../../../redux/renewalValuesReducer';
...
const [enrollment, setEnrollment] = useState(store.enrollmentDates)
...
const handleSaveInformation = () => {
  setSubmitting(true);
  dispatch(setBuildDeadlineRenewal(buildDeadline));
  dispatch(setEnrollmentDatesRenewal(enrollment));
  setTimeout(() => {
    console.log(store)
    setSubmitting(false)
    savedNotice()
